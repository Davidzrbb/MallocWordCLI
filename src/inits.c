...
void initStartGame() {
    ...
    generate_land(map_list[0], nb_line[0], nb_col[0], 1);  //map1
    generate_land(map_list[1], nb_line[1], nb_col[1], 2); //map 2
    generate_land(map_list[2], nb_line[2], nb_col[2], 3); //map 3
